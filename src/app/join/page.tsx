        ...
        <div className="p-6 sm:p-8 text-center">
          ...
          <div className="mt-6 pt-5 border-t border-gray-100 text-left space-y-3">
            ...
            <p className="text-[11px] text-gray-500 leading-relaxed">
              मंडळाचे अध्यक्ष <strong>पार्थ पाटील</strong> (bhawanimandirwale@gmail.com) यांच्याकडून मंडळ कोड किंवा प्रवेश मंजुरी मिळवण्यासाठी खालील बटनावर क्लिक करा:
            </p>
